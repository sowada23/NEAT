...
"""
Create a baseline benchmark plot.

This file makes an SVG graph showing how archived training checkpoints
perform against the baseline policy when evaluated after training.

In short:
- takes checkpoint benchmark history
- draws a mean line with variation band
