"""
Main JAX training script for NEAT self-play in SlimeVolley.
"""
...
from slimevolley.gpu_selfplay.evaluation import evaluate_selfplay_population, evaluate_vs_baseline
from slimevolley.gpu_selfplay.output import build_output_dir
from slimevolley.gpu_selfplay.viz.benchmark_plot import save_baseline_benchmark_svg
from slimevolley.gpu_selfplay.viz.gif import save_champion_gif
from slimevolley.gpu_selfplay.viz.topology import save_topology_evolution_gif


def main():
    parser = argparse.ArgumentParser(
        description="Train the local NEAT implementation on SlimeVolley using JAX self-play."
    )
    parser.add_argument("--generations", type=int, default=None)
    parser.add_argument("--tournaments", type=int, default=None)
    parser.add_argument("--population", type=int, default=100)
    parser.add_argument("--opponents-per-genome", type=int, default=24)
    parser.add_argument("--benchmark-episodes", type=int, default=100)
    parser.add_argument("--baseline-fitness-weight", type=float, default=0.90)
    parser.add_argument("--baseline-fitness-episodes", type=int, default=32)
    ...
    config = NEATConfig(
        ...
        min_bias=-3.0,
        max_bias=3.0,
        add_node_mutation_prob=0.1,
        add_conn_mutation_prob=0.2,
        remove_conn_mutation_prob=0.03,
